...
from .controllers import create_order, get_all_orders, get_order, update_order_status, delete_order

orders_bp = Blueprint('orders', __name__)

orders_bp.route('/create-order', methods=['POST'])(create_order)  # Create Order
orders_bp.route('/cart', methods=['GET'])(get_all_orders)  # Get All Orders
